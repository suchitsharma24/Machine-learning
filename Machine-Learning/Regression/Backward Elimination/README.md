## Backward Elimination model selection (manual)
...
**Case study:** Using manual Backward Elimination model selection method , choose the best subset of regressors among various spends like R&D, Administration, Marketing, and the State in which the company operates, to predict the profit variable for a given company.
